...
#define PROJECT_SOFTAP_ESP_WIFI_SSID CONFIG_ESP_WIFI_SOFTAP_SSID
#define PROJECT_SOFTAP_ESP_WIFI_PASS CONFIG_ESP_WIFI_SOFTAP_PASSWORD
#define PROJECT_SOFTAP_ESP_WIFI_CHANNEL CONFIG_ESP_WIFI_SOFTAP_CHANNEL
#define PROJECT_SOFTAP_MAX_STA_CONN CONFIG_ESP_MAX_STA_SOFTAP_CONN
